...
import { CreditCard, Wallet, TrendingUp, Mail, MessageSquare, Phone, Activity } from "lucide-react";
...
export default function Subscriptions() {
  ...
  useEffect(() => {
    if (!orgLoading && isPlatformAdmin === false) {
      notify.error("Access Denied", new Error("Only platform admins can access subscriptions."));
      navigate("/dashboard");
    }
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage billing, payments, and service usage</p>
          </div>
          ...
          <TabsContent value="usage" className="space-y-4">
            <div className="grid gap-4 md:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{usageTotals?.email || 0}</div>
                  <p className="text-xs text-muted-foreground">
                    Cost: ₹{usageTotals?.email_cost || 0}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{usageTotals?.whatsapp || 0}</div>
                  <p className="text-xs text-muted-foreground">
                    Cost: ₹{usageTotals?.whatsapp_cost || 0}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{usageTotals?.call || 0}</div>
                  <p className="text-xs text-muted-foreground">
                    Cost: ₹{usageTotals?.call_cost || 0}
                  </p>
                </CardContent>
              </Card>
            </div>
