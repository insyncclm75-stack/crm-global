-- Fix get_platform_admin_stats function to properly calculate all statistics
...
BEGIN
  ...
  -- Active users based on activity creation (users who actually used the platform)
  ...
  -- Email volume (outbound emails only)
