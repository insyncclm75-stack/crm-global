-- Drop and recreate the function with correct field names for the Revenue Dashboard
CREATE OR REPLACE FUNCTION public.get_monthly_actuals_optimized(_org_id UUID, _year INT)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
